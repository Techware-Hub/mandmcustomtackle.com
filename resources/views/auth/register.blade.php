...
<section class="mx-auto max-w-md px-4 py-14 sm:px-6 lg:px-8">
    <div class="rounded-lg border border-sky-100 bg-white p-6 shadow-sm">
        ...
        <form class="mt-6 grid gap-4">
            <input type="text" placeholder="Name" class="rounded-lg border border-sky-200 px-3 py-3">
            ...
            <button type="button" class="rounded-lg bg-blue-950 px-5 py-3 font-bold text-white">Register</button>
        </form>
